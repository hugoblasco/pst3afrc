...
function classement(numeroJour){
...
recu = requeteclass("classementH",numeroJour,0);
...
img.height=30;
		...
		if(document.getElementById("ligne"+i)!=null) {
			document.getElementById("ligne"+i).parentNode.removeChild(document.getElementById("ligne"+i));
		}
